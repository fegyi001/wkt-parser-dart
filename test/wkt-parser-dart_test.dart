...
void main() {
  group('Parser test', () {
    test('NZGD49 / New Zealand Map Grid [OGC WKT]', () {
      var output = wkt_parser.parse(test_data.testData[0]);
      expect(
        jsonEncode(output),
        equals(
    ...
    test('NAD83 / Massachusetts Mainland [OGC WKT]', () {
      var output = wkt_parser.parse(test_data.testData[1]);
      expect(
        jsonEncode(output),
        equals(
    ...
    test('HD72 / EOV [OGC WKT]', () {
      var output = wkt_parser.parse(test_data.testData[2]);
      expect(
        jsonEncode(output),
        equals(
    ...
    test('HD72 / EOV [ESRI WKT]', () {
      var output = wkt_parser.parse(test_data.testData[3]);
      expect(
        jsonEncode(output),
        equals(
